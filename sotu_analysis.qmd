...
-   
    ...
    We had the highest intercoder reliability in regards to the Disapproval category, with a Krippendorff's alpha of 0.912. The second highest intercoder reliability was with the Neutral category, with a Krippendorff's alpha was 0.801. Our lowest category was the Approval category, which had a Krippendorff's alpha of 0.735. From these metrics, it seems that our codebook captures and defines Disapproval of public health care relatively well; however, there is ambiguity in the codebook with regards to Neutral and Approval sentiments.
